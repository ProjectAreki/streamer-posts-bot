...
• 20% - Гиперссылки (<a href>)
• 20% - ЭМОДЗИ + URL (👉 https://...)
• 20% - URL в начале (https://... - текст)
• 20% - СТРЕЛКА + URL (→ https://...)
• 20% - ТЕКСТ + URL (текст - https://...)

📋 ВЫБЕРИ ОДИН из 10 форматов ниже (ЧЕРЕДУЙ типы!):
...
до 100.000 рублей на счет и плюсом 100 бесплатных спинов!""",
    ...
    # Каждый формат повторяется 3 раза для баланса
    LINK_FORMATS = [
        # ГИПЕРССЫЛКИ (20%)

...
✅ ИСПОЛЬЗУЙ ТОЧНЫЕ описания бонусов КАК ЕСТЬ:
   • Для {url1}: {bonus1}
   • Для {url2}: {bonus2}
❌ НЕ ПЕРЕФОРМУЛИРУЙ и НЕ СОКРАЩАЙ описания бонусов!
❌ НЕ ВЫДУМЫВАЙ свои описания — используй ТОЛЬКО те, что даны!
...
Ссылка 1 (Всегда выше): {url1} — ИСПОЛЬЗУЙ ТОЧНОЕ описание: {bonus1}
⚠️ НЕ ПЕРЕФОРМУЛИРУЙ! Пиши описание как дано!

Ссылка 2: {url2} — ИСПОЛЬЗУЙ ТОЧНОЕ описание: {bonus2}
⚠️ НЕ ПЕРЕФОРМУЛИРУЙ! Пиши описание как дано!
...
Первая (главная): {url1} — ТОЧНОЕ описание: {bonus1}
⚠️ Используй описание КАК ДАНО, не переписывай!

Вторая: {url2} — ТОЧНОЕ описание: {bonus2}
⚠️ Используй описание КАК ДАНО, не переписывай!
...
⚠️ ОПИСАНИЯ БОНУСОВ — ИСПОЛЬЗУЙ ТОЧНО КАК ДАНО:

Для {url1}: {bonus1} — ПИШИ ЭТО ОПИСАНИЕ КАК ЕСТЬ!

Для {url2}: {bonus2} — ПИШИ ЭТО ОПИСАНИЕ КАК ЕСТЬ!

❌ НЕ ПЕРЕФОРМУЛИРУЙ описания бонусов! ❌
...
{url1} — ТОЧНОЕ описание: {bonus1}
⚠️ ИСПОЛЬЗУЙ ОПИСАНИЕ КАК ДАНО! НЕ ПЕРЕФОРМУЛИРУЙ!

{url2} — ТОЧНОЕ описание: {bonus2}
⚠️ ИСПОЛЬЗУЙ ОПИСАНИЕ КАК ДАНО! НЕ ПЕРЕФОРМУЛИРУЙ!

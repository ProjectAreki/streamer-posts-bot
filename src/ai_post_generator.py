...
до 100.000 рублей на счет и плюсом 100 бесплатных спинов!""",
    ...
    async def _request_bonus_pool(self, original_desc: str, count: int, is_bonus1: bool) -> List[str]:
        ...
        prompt = f"""Сгенерируй {request_count} УНИКАЛЬНЫХ коротких описаний для рекламного бонуса.

ОРИГИНАЛ: "{original_desc}"

ГЛАВНОЕ ПРАВИЛО: Сохрани ТОЧНЫЕ цифры! Пиши цифрами (100 000, 100к, 100%), НЕ словами!

ПРАВИЛА:
1. Каждое описание — 5-25 слов, УНИКАЛЬНАЯ перефразировка
2. ЦИФРЫ ПИШИ ЦИФРАМИ: "100 000₽", "100к рублей", "150%", "100 спинов" — НЕ словами!
3. Сохрани валюту: рубли = рубли/₽/руб/тыс, доллары = $/доллары
4. НЕ добавляй данные которых НЕТ в оригинале
5. РАЗГОВОРНЫЙ русский: "забирай", "лови", "на старт", "в подарок", "на баланс", "сверху"
6. Чередуй стили: дружеский, энергичный, спокойный, деловой, интригующий, пацанский
7. Чередуй конструкции: "100к на счёт + 100 спинов", "пакет из 100 вращений и бонус 100к₽", "старт: 100к рублей плюс 100 FS"
8. БЕЗ HTML-тегов, БЕЗ эмодзи, чистый текст
9. КАЖДОЕ описание должно начинаться ПО-РАЗНОМУ!

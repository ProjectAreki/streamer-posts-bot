...
📊 БАЛАНС ФОРМАТОВ - РАВНОМЕРНО (соблюдай!):
• 20% - Гиперссылки (<a href>)
• 20% - ЭМОДЗИ + URL
• 20% - URL в начале  
• 20% - СТРЕЛКА + URL
• 20% - ТЕКСТ + URL
...
📊 БАЛАНС ФОРМАТОВ - РАВНОМЕРНО (соблюдай!):
• ~17% - Гиперссылки (<a href>)
• ~17% - ЭМОДЗИ + URL (👉 https://...)
• ~17% - URL + ТИРЕ (https://... - текст)
• ~17% - URL + НОВАЯ СТРОКА (https://...\nтекст)
• ~17% - СТРЕЛКА + URL (→ https://...)
• ~17% - ТЕКСТ + URL (текст - https://...)

📋 ВЫБЕРИ ОДИН из 12 форматов ниже (ЧЕРЕДУЙ типы!):

1️⃣ ГИПЕРССЫЛКА - классика:
   <a href="{url1}">🎁 Забрать приветственный бонус до 100.000 рублей</a>
   <a href="{url2}">💎 Получить стартовый пакет до 50.000 рублей</a>

2️⃣ ГИПЕРССЫЛКА - с акцентом:
   <a href="{url1}">⚡ ЗАБРАТЬ до 100.000 рублей на старте</a>
   <a href="{url2}">🔥 АКТИВИРОВАТЬ бонус до 50.000 рублей</a>

3️⃣ ЭМОДЗИ + URL:
   👉 {url1} - приветственный пакет до 100.000 рублей + 100 фриспинов
   👉 {url2} - стартовый бонус до 50.000 рублей на первый депозит

4️⃣ ЭМОДЗИ + URL (с рамкой):
   🔥 {url1} 🔥
   до 100.000 рублей + 100 фриспинов
   
   💰 {url2} 💰
   бонус до 50.000 рублей на депозит
...
6️⃣ URL + НОВАЯ СТРОКА + ТЕКСТ:
   {url1}
   ☝️ До 100.000 рублей + 100 фриспинов
   
   {url2}
   💰 Бонус до 50.000 рублей на депозит

7️⃣ URL + НОВАЯ СТРОКА (простой):
   {url1}
   Приветственный пакет до 100.000 рублей + 100 FS
   
   {url2}
   Стартовый бонус до 50.000 рублей на депозит

8️⃣ СТРЕЛКА + URL:
   → {url1}
   приветственный пакет до 100.000 рублей + фриспины
   
   → {url2}
   стартовый бонус до 50.000 рублей на депозит

9️⃣ СТРЕЛКА + URL (компактно):
   ➡️ {url1} - до 100.000 рублей + 100 FS
   ➡️ {url2} - бонус до 50.000 рублей

🔟 ТЕКСТ + ТИРЕ + URL:
   🎁 Забрать до 100.000 рублей на старте - {url1}
   💎 Получить бонус до 50.000 рублей - {url2}

1️⃣1️⃣ ТЕКСТ + ДВОЕТОЧИЕ + URL:
   🎁 Приветственный пакет до 100.000 рублей:
   {url1}
...
1️⃣2️⃣ ОПИСАНИЕ + URL (без эмодзи):
   Забрать приветственный бонус до 100.000 рублей - {url1}
   
   Получить стартовый пакет до 50.000 рублей - {url2}
...
• ЧЕРЕДУЙ типы начала: история → вопрос → факт → (редко) заголовок → история...
...
🎬 НАЧАЛО ПОСТА — ЧЕРЕДУЙ ТИПЫ (БАЛАНС ВАЖЕН!):

1️⃣ ПРЯМОЕ ПОВЕСТВОВАНИЕ (35%):
   • "Takuux зашел в Sugar Rush и случилось невероятное..."
   • "Вчера вечером один человек поставил 100 рублей..."
   • "Обычный вторник превратился в лучший день месяца для..."

2️⃣ ВОПРОС/ИНТРИГА (25%):
   • "Что может случиться с 50 рублями в Sweet Bonanza?"
   • "Вы когда-нибудь видели, как 200₽ превращаются в..."
   • "Знаете, почему Gates of Olympus называют 'печатной машинкой'?"

3️⃣ ЗАГОЛОВКИ (20% - не чаще!):
   • "🔥 <b>ВОТ ЭТО ЗАНОС!</b> 🔥"
   • "💀🏛 <b>ДРЕВНИЕ БОГИ ВЫБРАЛИ ГЕРОЯ!</b> 🏛💀"
   • "<u>ВНИМАНИЕ:</u> Рекордный выигрыш в прямом эфире!"

4️⃣ КОНСТАТАЦИЯ ФАКТА (15%):
   • "2 000 000₽. Два миллиона. С одного спина."
   • "x4340 на ставке в 100 рублей — это реально."
   • "Fire Portals выдал максимальный выигрыш. Опять."

5️⃣ ЭМОЦИЯ/РЕАКЦИЯ (5%):
   • "🤯 Я не верю своим глазам..."
   • "ВАУ! Просто ВАУ!"
   • "Ребята, вы это видели?!"

⚠️ ВАЖНО: НЕ используй заголовки в каждом посте! Максимум 1-2 из 10 постов.

🔀 БЛОКИ — перемешивай 3 элемента:
1. Интересное начало (см. выше)
...
до 100.000 рублей на счет и плюсом 100 бесплатных спинов!""",
    ...
    # Форматы ссылок с РАВНОМЕРНЫМ распределением
    # Каждый формат повторяется 3 раза для баланса (~16.67% каждый)
    LINK_FORMATS = [
        # ГИПЕРССЫЛКИ (~16.67%)
        "hyperlink", "hyperlink", "hyperlink",
        
        # ЭМОДЗИ + URL (~16.67%)
        "emoji_url_text", "emoji_url_text", "emoji_url_text",
        
        # URL + ТИРЕ + ТЕКСТ (~16.67%)
        "url_dash_text", "url_dash_text", "url_dash_text",
        
        # URL + НОВАЯ СТРОКА + ТЕКСТ (~16.67%)
        "url_newline_text", "url_newline_text", "url_newline_text",
        
        # СТРЕЛКА + URL (~16.67%)
        "arrow_url_text", "arrow_url_text", "arrow_url_text",
        
        # ТЕКСТ + URL (~16.67%)
        "text_dash_url", "text_dash_url", "text_dash_url",
    ]

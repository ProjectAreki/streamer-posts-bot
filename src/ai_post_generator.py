...
❌ ЗАПРЕЩЕНЫ клише: "не верим своим глазам", "до сих пор в шоке", "цифры говорят сами за себя"
...
• Любые фразы типа "на эти деньги даже X не купишь" — ЗАПРЕЩЕНЫ!
❌ ЗАПРЕЩЕНЫ шаблонные заголовки: "X рублей — цена/это/сумма на которую..."
❌ ЗАПРЕЩЕНЫ клише: "не верим своим глазам", "цифры говорят сами за себя", "готов повторить?"
...
═══════════════════════════════════════════════════════════════
📊 ГОТОВЫЙ БЛОК ЦИФР (ВСТАВЬ ЕГО ОДИН РАЗ В ПОСТ!):
═══════════════════════════════════════════════════════════════

{chosen_format}

⚠️ КРИТИЧЕСКИ ВАЖНО:
1. Вставь этот блок ОДИН РАЗ в пост (не дублируй!)
2. НЕ создавай свой блок с цифрами — используй ТОЛЬКО этот!
3. Можешь изменить расположение блока в посте, но сам текст блока — БЕЗ ИЗМЕНЕНИЙ!
4. Данные о ставке/выигрыше/множителе из секции ДАННЫЕ — это справка для контекста, НЕ для вставки!
"""

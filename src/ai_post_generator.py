...
⚠️ ОПИСАНИЯ БОНУСОВ — ГЕНЕРИРУЙ УНИКАЛЬНО КАЖДЫЙ РАЗ!
Для {url1}: {bonus1}
Для {url2}: {bonus2}

✅ ПРИДУМЫВАЙ описания САМИ на основе бонусов выше!
✅ Каждый раз НОВАЯ формулировка — синонимы, перестановка слов, другой стиль!
❌ НИКАКИХ шаблонных фраз типа "Забрать бонус", "Активировать", "Получить"!
❌ НЕ ПОВТОРЯЙ формулировки из предыдущих постов!
...
до 100.000 рублей на счет и плюсом 100 бесплатных спинов!""",
    ...
    def _apply_bonus_desc_formatting(self, text: str) -> str:
        ...
        - Не дублирует форматирование (пропускает уже отформатированные)
...
"""
                ...
                # 🎨 Рандомное HTML-форматирование описаний бонусов

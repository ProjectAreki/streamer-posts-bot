...
⚠️ ОПИСАНИЯ БОНУСОВ (КРИТИЧЕСКИ ВАЖНО!):
Для {url1}: {bonus1}
Для {url2}: {bonus2}

✅ Формулируй описания ПО-РАЗНОМУ каждый раз (синонимы, разные обороты)
⛔ НО ОБЯЗАТЕЛЬНО включай ВСЕ элементы бонуса:
   • Для ссылки 1: И фриспины, И сумму к депозиту!
   • Для ссылки 2: И процент, И бесплатные вращения!
❌ НЕ ПРОПУСКАЙ части бонуса! Если есть фриспины — пиши про них!
...
🎨 ПРАВИЛО ОДИНАКОВОГО ФОРМАТИРОВАНИЯ БОНУСОВ:
• ОБА описания бонусов в одном посте ОФОРМЛЯЙ ОДИНАКОВО!
• Пример: если bonus1 с <b>, то bonus2 тоже с <b>
• Варианты: <b>описание</b>, <i>описание</i>, <code>описание</code>
• В РАЗНЫХ постах используй РАЗНОЕ форматирование!
...
✅ Формулируй ПО-РАЗНОМУ каждый раз!
⛔ НО ОБЯЗАТЕЛЬНО упоминай И фриспины, И сумму к депозиту!

Ссылка 2: {url2} — Бонусы: {bonus2}
✅ Формулируй ПО-РАЗНОМУ каждый раз!
⛔ НО ОБЯЗАТЕЛЬНО упоминай И процент к депозиту, И бесплатные вращения!
...
✅ Формулируй ПО-РАЗНОМУ! ⛔ НО ВКЛЮЧАЙ ВСЕ: фриспины + сумму!

Вторая: {url2} — Бонусы: {bonus2}
✅ Формулируй ПО-РАЗНОМУ! ⛔ НО ВКЛЮЧАЙ ВСЕ: процент + вращения!
...
✅ Формулируй ПО-РАЗНОМУ каждый раз (синонимы, разные обороты)!
⛔ НО ВКЛЮЧАЙ ВСЕ ЭЛЕМЕНТЫ:
   • Ссылка 1: фриспины + сумма к депозиту (не пропускай!)
   • Ссылка 2: процент + вращения (не пропускай!)
...
{url1} — Бонусы: {bonus1}
✅ Формулируй ПО-РАЗНОМУ! ⛔ ОБЯЗАТЕЛЬНО: фриспины + сумма!

{url2} — Бонусы: {bonus2}
✅ Формулируй ПО-РАЗНОМУ! ⛔ ОБЯЗАТЕЛЬНО: процент + вращения!
...
• "Всего 80₽", "скромные 40₽", "минимальный вход"
• Риск, смелость, азарт — главная эмоция
...
до 100.000 рублей на счет и плюсом 100 бесплатных спинов!""",
    ...
    def _get_anti_repetition_instruction(self) -> str:
        ...
        format_names = {
            ...
            # === ГИПЕРССЫЛКИ (24-38) ===
            24: "<a href=\"URL\">Забрать бонус</a> — описание бонуса",
            25: "<a href=\"URL\">Получить сейчас</a> — описание бонуса",
            26: "<a href=\"URL\">Активировать</a> — описание бонуса",
            27: "<a href=\"URL\">Жми сюда</a> — описание бонуса",
            28: "<a href=\"URL\">Твой бонус тут</a> — описание бонуса",
            29: "<a href=\"URL\">🎁 Забрать</a> — описание бонуса",
            30: "<a href=\"URL\">🔥 Получить</a> — описание бонуса",
            31: "<a href=\"URL\">💰 Бонус</a> — описание бонуса",
            32: "<a href=\"URL\">Старт здесь</a> — описание бонуса",
            33: "<a href=\"URL\">Ловить удачу</a> — описание бонуса",
            34: "описание бонуса — <a href=\"URL\">забрать тут</a>",
            35: "описание бонуса — <a href=\"URL\">получить</a>",
            36: "описание бонуса — <a href=\"URL\">активировать</a>",
            37: "описание бонуса → <a href=\"URL\">тут</a>",
            38: "🎁 описание бонуса — <a href=\"URL\">забрать</a>",

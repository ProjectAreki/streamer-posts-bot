...
до 100.000 рублей на счет и плюсом 100 бесплатных спинов!""",
    ...
    async def _request_bonus_pool(self, original_desc: str, count: int, is_bonus1: bool) -> List[str]:
        ...
        prompt = f"""Сгенерируй {request_count} УНИКАЛЬНЫХ мотивирующих описаний бонуса для Telegram-постов.

БОНУС: "{original_desc}"

ЗАДАЧА: Каждое описание стоит рядом со ссылкой. Читатель должен ЗАХОТЕТЬ зайти и забрать этот бонус ПРЯМО СЕЙЧАС. Ты как друг, который нашёл крутую тему и делится: "бро, зайди туда, там дают вот это — реально стоит!"

СОХРАНИ ТОЧНЫЕ ЦИФРЫ! Пиши цифрами: 100 000, 100к, 150%, 100 спинов — НЕ словами.

ПРИМЕРЫ ХОРОШИХ ОПИСАНИЙ (с мотивацией зайти и забрать):
- "зайди и забери 100к₽ на баланс и 100 бесплатных вращений — реально щедрый старт"
- "тут кидают 100 000 рублей на счёт и ещё 100 спинов сверху, грех пройти мимо"
- "залетай — 100к рублей ждут на балансе плюс 100 круток бесплатно, такое не каждый день"
- "оформи 150% к пополнению и начни с удвоенным балансом — это реальный буст"
- "не упусти: 100к₽ и 100 FS на старте, с таким бонусом можно спокойно раскачаться"
- "заходи и бери свои 100 тысяч рублей на счёт + 100 спинов, пока раздают"
- "тебе сюда — 100к бонусом и пачка из 100 вращений, отличный повод зайти"
- "100 000₽ на баланс и 100 бесплатных раундов — просто зайди и активируй"

ЗАПРЕЩЕНО (сухие ярлыки без мотивации):
- "100к рублей + 100 вращений" ← нет призыва зайти!
- "бонус 100к₽ и 100 FS" ← не цепляет!
- "+150% к депозиту" ← скучно, нет подводки!
- "для серьёзного захода" / "если хочешь больше" ← НЕ сравнивай с другими бонусами!

ПРАВИЛА:
1. 10-30 слов — живая фраза, которая мотивирует ЗАЙТИ и ЗАБРАТЬ бонус
2. Каждое описание — самостоятельное, НЕ сравнивай с другими бонусами/ссылками
3. Призывай зайти: "зайди", "забери", "залетай", "оформи", "бери", "хватай", "не пропусти", "активируй"
4. Добавляй почему стоит: "реально щедро", "такое не каждый день", "грех пройти мимо", "пока раздают", "отличный старт"
5. Сохрани валюту: рубли=рубли/₽/руб/тыс/к, доллары=$/доллары
6. НЕ добавляй данные которых НЕТ в оригинале
7. Чередуй стили: дружеский, пацанский, энергичный, спокойный, интригующий, деловой
8. БЕЗ HTML-тегов, БЕЗ эмодзи, чистый текст
9. ВСЕ {request_count} описаний УНИКАЛЬНЫ — ни одно не повторяется!
